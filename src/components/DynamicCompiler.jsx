...
export default function DynamicCompiler({ defaultCode }) {
  ...
  const handleExplainAIbutton = () => {
    const m = jsxCode + 'can you explain this?'
    handleSendMessage(m);
    setIsCollapsed(true);
  }
    ...
    <div className="p-1 space-y-6 flex flex-col">
      ...
      <div className="relative">
        ...
        <div className="shrink-0 flex justify-center">
            <button onClick={handleExplainAIbutton} className="text-[#2A0A12] bg-yellow-400 hover:bg-yellow-500 hover:scale-[1.03] focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-800 font-semibold rounded-xl text-base px-6 py-3 transition-transform duration-200 shadow-lg hover:shadow-yellow-400/50 whitespace-nowrap">
              Explain With AI
            </button>
          </div>
